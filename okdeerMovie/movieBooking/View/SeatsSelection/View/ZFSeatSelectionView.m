...
-(instancetype)initWithFrame:(CGRect)frame SeatsArray:(NSMutableArray *)seatsArray seatBtnActionBlock:(void (^)(id))actionBlock{
...
-(void)initcenterLine:(NSMutableArray *)seatsArray{
    ...
    // Y值 顶住顶部
    self.centerLine.y = self.seatScrollView.contentOffset.y;
...
-(void)initSeatsView:(NSMutableArray *)seatsArray{
    ...
    self.seatScrollView.contentInset = UIEdgeInsetsMake(ZFseastsColMargin, (self.width - seatView.seatViewWidth)/2, 20, (self.width - seatView.seatViewWidth)/2);
}
